      ...
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-brand footer-reveal">
            ...
            <div className="footer-badges">
              ...
              <span className="footer-badge footer-badge--red">
                <FaAward />
                Excellence in Education
              </span>
              <span className="footer-badge footer-badge--blue">
                <FaStar />
                Holistic Learning
              </span>
            </div>
          ...
          <div className="footer-column footer-reveal">
            <h4 className="footer-heading">
              <FaChevronRight className="footer-heading-icon" />
              Quick Links
            </h4>
            <ul className="footer-list">
              {quickLinks.map((link) => (
          ...
          <div className="footer-contact footer-reveal">
            ...
            <div className="footer-contact-list">
              ...
              <a href="tel:+919788914441" className="footer-contact-item footer-contact-item--link">
                <div className="footer-contact-icon">
                  <FaPhoneAlt />
                </div>
                <div>
              ...
              <a href="mailto:info@sngacbse.com" className="footer-contact-item footer-contact-item--link">
                <div className="footer-contact-icon">
                  <FaEnvelope />
                </div>
                <div>
              ...
              <div className="footer-contact-item">
                ...
                <div>
                  <span className="footer-contact-label">Office Hours</span>
        ...
        <div className="footer-cta footer-reveal">
          <div className="footer-cta-content">
            ...
            <div>
              <span className="footer-cta-tag">
                <FaHeart className="footer-cta-heart" />
                ADMISSIONS OPEN
              </span>
              <h3 className="footer-cta-title">
                Give your child the opportunity to learn, grow and excel.
          ...
          <Link to="/admissions" className="footer-cta-btn">
            <span>Admission Enquiry</span>
            <FaArrowRight className="footer-cta-btn-icon" />
          </Link>
        </div>
        ...
        <div className="footer-bottom footer-reveal">
          <div className="footer-bottom-left">
            <FaSchool className="footer-bottom-icon" />
            <span>© {new Date().getFullYear()} Shifan Noor Global Academy.</span>
            <span className="footer-bottom-dot">•</span>
            <span>All rights reserved.</span>
          </div>
          ...
          <div className="footer-bottom-center">
            <span className="footer-bottom-tag">LEARN</span>
            <span className="footer-bottom-sep"></span>
            <span className="footer-bottom-tag">GROW</span>
            <span className="footer-bottom-sep"></span>
            <span className="footer-bottom-tag">LEAD</span>
            <span className="footer-bottom-sep"></span>
            <span className="footer-bottom-tag">EXCEL</span>
          </div>

          <div className="footer-bottom-right">
            <span className="footer-bottom-credit">
              Made with <FaHeart className="footer-bottom-heart" /> by SNGA
            </span>
          </div>
