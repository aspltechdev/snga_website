...
import studyImage from "../../assets/holistic.jpg";
...
const Examinations = () => {
  const assessmentAreas = [
    ...
    },
    {
      ...
      title: "Preparation",
      description:
        "A structured academic environment helps students develop discipline, confidence and learning habits needed for future challenges.",
      image: valuesImage,
    },
  ];
  ...
  return (
    <main className="examinations-page">
      ...
      <section className="examinations-hero">
        ...
        <div className="examinations-hero__image">
          <img
            src={schoolImage}
        ...
        <div className="examinations-hero__overlay" />

        <div className="examinations-container examinations-hero__inner">

          <div className="examinations-hero__top">
            <span>SHIFAN NOOR GLOBAL ACADEMY</span>
            <span>ACADEMICS · ASSESSMENT</span>
          </div>

          <div className="examinations-hero__content">

            <div className="examinations-hero__index">
              05
            </div>

            <p className="examinations-kicker">
              EXAMINATIONS & ASSESSMENT
            </p>
            ...
            <p className="examinations-hero__description">
              Assessment that helps students understand their progress,
              strengthen their learning and prepare for the challenges ahead.
            </p>
          ...
          <div className="examinations-hero__bottom">
      ...
      <section className="examinations-intro">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-section-label">
            <span>01</span>
            OUR APPROACH
          </div>

          <div className="examinations-intro__grid">
            ...
            <div className="examinations-intro__copy">

              <p className="examinations-lead">
                At Shifan Noor Global Academy, assessment forms part
                of the wider learning process.
              </p>

              <p>
                It gives students opportunities to demonstrate their
                understanding and gives educators insight into student
                progress.
              </p>

              <p>
                The aim is not simply to produce examination results,
                but to help students develop strong learning habits,
                confidence and the ability to approach challenges
                responsibly.
              </p>
      ...
      <section className="examinations-philosophy">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-philosophy__grid">
            ...
            <div className="examinations-philosophy__copy">

              <div className="examinations-philosophy__rule" />

              <p>
                Assessment is an important part of academic learning.
                It helps students reflect on what they know, identify
                areas that need attention and continue developing
                their understanding.
              </p>

              <p>
                For educators, assessment provides valuable feedback
                that can support teaching and help address individual
                learning needs.
              </p>
      ...
      <section className="examinations-areas">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-section-heading">
            ...
            <p>
              Assessment can provide a broader picture of student
              learning, understanding and progress.
            </p>

          </div>

          <div className="examinations-area-list">

            {assessmentAreas.map((area) => (
              <article
                className="examinations-area-row"
                key={area.number}
              >

                <div className="examinations-area-row__number">
                  {area.number}
                </div>

                <div className="examinations-area-row__image">
                  <img
                    src={area.image}
                    alt={area.title}
                    loading="lazy"
                ...
                <div className="examinations-area-row__content">
                ...
                <span className="examinations-area-row__arrow">
                  →
                </span>
      ...
      <section className="examinations-cycle">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-section-label examinations-section-label--light">
            <span>03</span>
            THE LEARNING CYCLE
          </div>

          <div className="examinations-cycle__header">
            ...
            <p>
              Learning becomes stronger when preparation, practice,
              evaluation and improvement are treated as connected
              parts of the academic journey.
            </p>

          </div>

          <div className="examinations-cycle__list">

            {learningCycle.map((item) => (
              <article
                className="examinations-cycle__item"
                key={item.number}
              >
      ...
      <section className="examinations-support">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-support__grid">

            <div className="examinations-support__image">
              <img
                src={engagingImage}
              ...
              <div className="examinations-support__caption">
                <span>STUDENT PREPARATION</span>
                <strong>
                  Confidence grows
                  <br />
                  through preparation.
            ...
            <div className="examinations-support__content">
              ...
              <p>
                A positive academic environment encourages students
                to approach examinations with preparation, discipline
                and confidence.
              </p>

              <p>
                Teachers can guide students by identifying areas that
                need further attention and helping them develop stronger
                learning strategies.
              </p>

              <Link
                to="/faculties"
                className="examinations-text-link"
              >
                Meet Our Educators
                <span>→</span>
              </Link>
      ...
      <section className="examinations-excellence">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-excellence__grid">
            ...
            <div>
              ...
              <p className="examinations-lead">
                SNGA's educational vision places importance on
                academic excellence while also recognising the
                development of skills, values, confidence and
                all-round growth.
              </p>

              <p>
                Examination performance is therefore considered
                alongside the wider development of the student.
              </p>
          ...
          <div className="examinations-pillars">
      ...
      {/* =====================================================
          BEYOND THE EXAM
      ===================================================== */}
      <section className="examinations-beyond">

        <div className="examinations-container">

          <div className="examinations-beyond__grid">
            ...
            <div className="examinations-beyond__copy">

              <p className="examinations-lead">
                The ultimate goal of education is to prepare students
                for life beyond school. Examinations are one part
                of that journey.
              </p>

              <p>
                Knowledge, communication, confidence, responsibility
                and the ability to face challenges are equally
                important outcomes of a complete education.
              </p>

              <div className="examinations-beyond__words">
                <span>KNOWLEDGE</span>
                <span>SKILLS</span>
                <span>VALUES</span>
                <span>CONFIDENCE</span>
      ...
      {/* =====================================================
          RELATED ACADEMICS
      ===================================================== */}
      <section className="examinations-explore">
        ...
        <div className="examinations-container">
          ...
          <div className="examinations-explore__grid">

            <Link
              to="/curriculum"
              className="examinations-explore-card"
            >
            ...
            <Link
              to="/results"
              className="examinations-explore-card examinations-explore-card--red"
            >
              <span>RESULTS</span>
      ...
      <section className="examinations-cta">
        ...
        <div className="examinations-cta__image">
          <img
            src={schoolImage}
        ...
        <div className="examinations-cta__overlay" />

        <div className="examinations-container examinations-cta__inner">
          ...
          <div className="examinations-cta__actions">
